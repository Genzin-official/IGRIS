  ...
  return (
    <aside id="app-sidebar" className="w-[260px] bg-[#F7F7F8] border-r border-[#E5E5E5] flex flex-col h-full shrink-0 select-none">
            ...
            return (
              <div
                ...
                className={`group flex items-center justify-between p-2.5 rounded-lg cursor-pointer transition-all duration-150 relative border ${
                  isActive
                    ? 'bg-white shadow-sm border-gray-100 text-[#111111] font-medium'
      ...
      <div className="p-4 border-t border-[#E5E5E5] bg-white space-y-4">
            ...
            {AVAILABLE_MODELS.map((model) => (
              ...
              >
                <div className="flex items-center gap-1.5 justify-between">
                  <span className={`text-xs font-semibold ${selectedModelId === model.id ? 'text-black' : 'text-gray-600'}`}>
                    {model.name}
                  </span>
                  {model.isPremium && (
                ...
                <p className="text-[10px] text-gray-400 line-clamp-1 mt-0.5 leading-relaxed">
                  {model.description}
                </p>
              </button>
            ))}
        ...
        <div className="flex items-center justify-between p-2.5 rounded-xl bg-[#F7F7F8] border border-[#E5E5E5]/40">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <span className="text-[9px] text-gray-400 block">Real-time search</span>
            </div>
          </div>
          <button
        ...
        <div className="flex items-center gap-2 text-[9px] text-gray-400 bg-gray-50 p-2 rounded-lg border border-gray-100">
